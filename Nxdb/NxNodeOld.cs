...
namespace Nxdb
{
    ...
    public class NxNodeOld //: IEquatable<NxNode>
    {
        ...
        internal NxNodeOld(Database database, int pre)
            : this(database, pre, database.GetId(pre))
        {}

        internal NxNodeOld(Database database, int pre, int id)
        {
        ...
        internal NxNodeOld(Database database, DBNode node)
        {
            if (database == null) throw new ArgumentNullException("database");
        ...
        internal NxNodeOld(Database database, ANode node)
        {
            if (database == null) throw new ArgumentNullException("database");
            if (node == null) throw new ArgumentNullException("node");
            _database = database;
        ...
        internal static XmlNode GetXmlNode(NxNodeOld node)
        {
        ...
        */
        ...
        private IEnumerable<NxNodeOld> EnumerateNodes(NodeIter iter)
        {
            IterEnum iterEnum = new IterEnum(_database, iter);
            return iterEnum.Cast<NxNodeOld>();
        }
        ...
        public IEnumerable<NxNodeOld> Children
        {
            get
            {
                CheckValid();
        ...
        public NxNodeOld Child(int index)
        {
            return Children.ElementAtOrDefault(index);
        }

        public IEnumerable<NxNodeOld> ChildElements
        {
            get { return Children.Where(c => c._aNode.ndType() == ItemNodeType.ELM); }
        }

        public NxNodeOld ChildElement(int index)
        {
            return ChildElements.ElementAtOrDefault(index);
        }

        public IEnumerable<NxNodeOld> FollowingSiblings
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> PrecedingSiblings
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> Following
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> Preceding
        {
            get
            {
                CheckValid();
        ...
        public NxNodeOld Parent
        {
            get
            {
                CheckValid();
                ANode node = _aNode.parent();
                return node == null ? null : new NxNodeOld(_database, node);
            }
        }

        public IEnumerable<NxNodeOld> Ancestors
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> AncestorsOrSelf
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> Descendants
        {
            get
            {
                CheckValid();
        ...
        public IEnumerable<NxNodeOld> DescendantsOrSelf
        {
            get
            {
                CheckValid();
        ...
        /// </summary>
        public IEnumerable<NxNodeOld> Attributes
        {
            get
            {
        ...
        public NxNodeOld Attribute(string name)
        {
